...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create list_item' do
    assert_difference('ListItem.count') do
      post list_items_url,
           params: { list_item: { users_id: @list_item.users_id, lists_id: @list_item.lists_id,
                                  text: @list_item.text } }
    end
  ...
  test 'should update list_item' do
    patch list_item_url(@list_item),
          params: { list_item: { users_id: @list_item.users_id, lists_id: @list_item.lists_id, text: @list_item.text } }
